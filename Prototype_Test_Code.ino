...
float AcX,AcY,AcZ,MgX,MgY,roll,pitch,heading,volti,current_level,maximum_altitude,previous_level,delta,alt,cal_alt,cal_roll,cal_pitch;
boolean telem = 0;
static float Pi = 3.14159;
int m_time, m_count,pct,pkt,count,count2,pos = 0,cam_trigger = 4,rpm = 0,x = 0,y = 0,z = 20,activated_flag = 1,previous_state = 0,release_flag = 0;
int d = 0;
int Pin1 = 6; 
int Pin2 = 7; 
int Pin3 = 8; 
